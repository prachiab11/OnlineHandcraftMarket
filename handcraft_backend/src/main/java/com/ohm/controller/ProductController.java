...
public class ProductController {
	...
	public ResponseEntity<?> getProductDetailsByState(@PathVariable String productState) {
		...
		//
		//if (((Optional<Product>) productByState).isPresent())
			//return new ResponseEntity<>(productByState.get(), HttpStatus.OK);
		//else
			//throw new ProductNotFoundException("Product with State " + productByState + " Not Found");
